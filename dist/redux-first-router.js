...
"use strict";
/* WEBPACK VAR INJECTION */(function(__dirname) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return onError; });
...
/* unused harmony default export */ var _unused_webpack_default_export = (logError);
...
// CONCATENATED MODULE: ./src/utils/isServer.js
/* harmony default export */ var isServer = (function () {
...
/* harmony default export */ var actionToUrl = (function (action, api, prevRoute) {
  ...
  try {
    ...
    var pathname = compileUrl(path, p, q, h, route, opts) || '/'; // path-to-regexp throws for failed compilations; we made our queries + hashes also throw to conform
    var url = bn + pathname;
...
var actionToUrl_formatHash = function formatHash() {
...
var urlToAction_createAction = function createAction(loc, routes, opts) {
  ...
  for (var i = 0; i < types.length; i++) {
    ...
    var transformers = { formatParams: urlToAction_formatParams, formatQuery: urlToAction_formatQuery, formatHash: urlToAction_formatHash };
...
var urlToAction_formatParams = function formatParams(params, route, opts) {
...
var toAction_typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
...
/* harmony default export */ var toAction = (function (api, entry, st, k) {
  ...
  } else if ((typeof entry === 'undefined' ? 'undefined' : toAction_typeof(entry)) === 'object') {
...
var urlToLocation_typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
...
/* harmony default export */ var urlToLocation = (function (url) {
  if ((typeof url === 'undefined' ? 'undefined' : urlToLocation_typeof(url)) === 'object' && url.pathname !== undefined) return url;
...
var path_to_regexp = __webpack_require__(1);
var path_to_regexp_default = /*#__PURE__*/__webpack_require__.n(path_to_regexp);

// CONCATENATED MODULE: ./src/utils/matchUrl.js
var matchUrl_typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
...
var matchVal = function matchVal(val,
// TODO: What flow-type is best for expected
// $FlowFixMe
expected, key, route, opts) {
  var type = typeof expected === 'undefined' ? 'undefined' : matchUrl_typeof(expected);
...
var matchUrl_compilePath = function compilePath(pattern) {
  ...
  var keys = [];
  var re = path_to_regexp_default()(pattern, keys, { end: !partial, strict: strict });
...
/* harmony default export */ var compileUrl = (function (path) {
  ...
  var toPath = toPathCache[path] = toPathCache[path] || Object(path_to_regexp["compile"])(path);
...
/* harmony default export */ var shouldCall = (function (name, route, req) {
...
/* harmony default export */ var createCache = (function (api, name, config) {
  ...
  var _api$options$createCa = api.options.createCacheKey,
      createCacheKey = _api$options$createCa === undefined ? defaultCreateCacheKey : _api$options$createCa;
  ...
  return { isCached: isCached, cacheAction: cacheAction, clear: clear };
});
...
/* harmony default export */ var pathlessRoutes_changeBasename = (function (_ref) {
  ...
  return dispatch({ type: type, params: params, query: query, state: state, hash: hash, basename: basename });
});
...
/* harmony default export */ var formatRoutes = (function (input, formatter) {
  ...
  if (!isAddRoutes) {
    ...
    routes[ADD_ROUTES] = input[ADD_ROUTES] || { thunk: pathlessRoutes_addRoutes, dispatch: false };
    routes[CHANGE_BASENAME] = input[CHANGE_BASENAME] || { thunk: pathlessRoutes_changeBasename, dispatch: false };
    routes[CLEAR_CACHE] = input[CLEAR_CACHE] || { thunk: pathlessRoutes_clearCache };
    routes[CONFIRM] = input[CONFIRM] || { thunk: pathlessRoutes_confirm, dispatch: false };
...
var formatRoutes_formatRoute = function formatRoute(r, type, routes, formatter) {
  ...
  var route = typeof r === 'string' ? { path: r } : r;
...
/* harmony default export */ var redirectShortcut = (function (_ref) {
  ...
  // $FlowFixMe
  return dispatch(actions_redirect({ ...action, type: type }, 301));
});
// CONCATENATED MODULE: ./src/utils/callRoute.js
var callRoute_typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
...
/* harmony default export */ var callRoute = (function (routes) {
  return function (action, key) {
    ...
    action = (typeof action === 'undefined' ? 'undefined' : callRoute_typeof(action)) === 'object' ? action : { type: type };
...
// CONCATENATED MODULE: ./src/utils/createSelector.js

// TODO: Assess and add better flow annotations
/* harmony default export */ var createSelector = (function (name, selector) {
...
function nestAction_objectWithoutProperties(obj, keys) { var target = {}; for (var i in obj) { if (keys.indexOf(i) >= 0) continue; if (!Object.prototype.hasOwnProperty.call(obj, i)) continue; target[i] = obj[i]; } return target; }
...
/* harmony default export */ var utils_parseSearch = (function (search) {
  return lib_default.a.parse(search, { decoder: decoder });
});

var decoder = function decoder(str, decode) {
  return parseSearch_isNumber(str) ? parseFloat(str) : decode(str);
};
...
var toEntries_typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
...
var Request = function Request(action, api, next) {
  _classCallCheck(this, Request);

  createRequest_initialiseProps.call(this);
...
var createRequest_initialiseProps = function _initialiseProps() {
  var _this = this;
  ...
  this.confirm = function () {
    ...
    if (!canLeave) {
      return _this.realDispatch({ type: UNBLOCK });
    }
  ...
  this.block = function () {
    ...
    return _this.realDispatch({ type: BLOCK, payload: { ref: ref } });
  };
  ...
  this.handleDoubleDispatchRedirect = function (res) {
    ...
    _this.realDispatch({ type: SET_FROM, payload: { ref: ref } });
  ...
  this.populateAction = function (act) {
    ...
    var action = isAction(act) ? act : typeof act === 'string' && (type = _this.isActionType(act)) ? { type: type } : { payload: act };
...
function createReducer_objectWithoutProperties(obj, keys) { var target = {}; for (var i in obj) { if (keys.indexOf(i) >= 0) continue; if (!Object.prototype.hasOwnProperty.call(obj, i)) continue; target[i] = obj[i]; } return target; }
...
var History_History = function () {
  function History(routes) {
    ...
    var _restore2 = this._restore(),
        n = _restore2.n,
        index = _restore2.index,
        entries = _restore2.entries; // delegate to child classes to restore


    var action = entries[index];
    var info = { kind: kind, n: n, index: index, entries: entries };
  ...
  _createClass(History, [{
    ...
    value: function _notify(action, info, commit) {
      ...
      action = {
        ...
        location: { ...action.location, ...info, length: length, n: n2 }
      };
    ...
    value: function push(path) {
      ...
      if (n) return this.jump(n, false, undefined, { state: state }, notify);
      ...
      var info = { kind: kind, index: index, entries: entries };
    ...
    value: function replace(path) {
      ...
      var info = { kind: kind, entries: entries, index: index };
    ...
    value: function jump(delta) {
      ...
      var info = { kind: kind, index: index, entries: entries, n: n };
      ...
      return this._notify(action, info, commit, notify, { prev: prev, revertPop: revertPop });
    }
  }, {
    key: 'back',
    value: function back(state) {
      ...
      return this.jump(-1, false, -1, { state: state }, notify);
    }
  }, {
    key: 'next',
    ...
    value: function replacePop(path) {
      ...
      var newInfo = { kind: kind, entries: entries, index: index };
    ...
    value: function reset(ents, i, n) {
      ...
      return this._notify(action, info, commit, notify, { prev: prev, from: from });
    }
  }, {
    key: 'canJump',
    ...
    value: function _createPrev(_ref, currentEntry) {
      ...
      var action = { ...entry, location: { ...entry.location, index: index, scene: scene } };
    ...
    value: function _findResetFirstAction(entry) {
      ...
      if ((typeof entry === 'undefined' ? 'undefined' : History_typeof(entry)) === 'object' && entry.type) {
        var action = entry;
...
var saveHistory = function saveHistory(_ref, out) {
  ...
  sessionStorage_set({ index: index, entries: entries, out: out });
};
...
var pushState = function pushState(url) {
  return window.history.pushState({ id: sessionId() }, null, url);
}; // insure every entry has the sessionId (called by `BrowserHistory`)

var replaceState = function replaceState(url) {
  return window.history.replaceState({ id: sessionId() }, null, url);
...
var BrowserHistory_BrowserHistory = function (_History) {
...
/* harmony default export */ var history_BrowserHistory = (BrowserHistory_BrowserHistory);
var tries = 0;
var maxTries = 10;
var queue = [];
...
function MemoryHistory_possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function MemoryHistory_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var MemoryHistory_MemoryHistory = function (_History) {
  MemoryHistory_inherits(MemoryHistory, _History);

  function MemoryHistory() {
    MemoryHistory_classCallCheck(this, MemoryHistory);

    return MemoryHistory_possibleConstructorReturn(this, (MemoryHistory.__proto__ || Object.getPrototypeOf(MemoryHistory)).apply(this, arguments));
  }
...
/* harmony default export */ var history_MemoryHistory = (MemoryHistory_MemoryHistory);
...
/* harmony default export */ var createHistory = (function (routes) {
  var opts = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return supportsDom() && supportsHistory() && opts.testBrowser !== false ? new history_BrowserHistory(routes, opts) : new history_MemoryHistory(routes, opts);
});
...
function formatAction_objectWithoutProperties(obj, keys) { var target = {}; for (var i in obj) { if (keys.indexOf(i) >= 0) continue; if (!Object.prototype.hasOwnProperty.call(obj, i)) continue; target[i] = obj[i]; } return target; }
...
/* harmony default export */ var formatAction = (function (req) {
  ...
  var _ref = !req.commitHistory ? actionToUrl(action, req, prevRoute) : { url: action.location.url, state: action.state },
      url = _ref.url,
      state = _ref.state;
...
/* harmony default export */ var replacePopAction = (function (n, url, curr, tmp) {
  ...
  if (!isNAdjacentToSameUrl(url, curr, n)) {
    ...
    return { n: n, entries: entries, index: index, prevUrl: _prevUrl };
  }
  ...
  return { n: n, entries: entries, index: newIndex, prevUrl: prevUrl };
});
...
/* harmony default export */ var transformAction = (function () {
  return function (req, next) {
    ...
    Object.assign(req, { type: type, params: params, query: query, state: state, hash: hash, basename: basename, location: location }); // assign to `req` for conevenience (less destructuring in callbacks)
...
var call_slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }();
...
/* harmony default export */ var pathlessRoute = (function () {
  ...
  return function (api) {
    ...
    var pipeline = api.options.compose(middlewares, api);
...
// CONCATENATED MODULE: ./src/middleware/changePageTitle.js
var changePageTitle_this = undefined;

function changePageTitle_asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; }



/* harmony default export */ var changePageTitle = (function (api) {
  return function () {
    var _ref = changePageTitle_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, next) {
      var title;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
...
/* harmony default export */ var createRouter = (function () {
  ...
  call('beforeLeave', { prev: true }), call('beforeEnter'), enter, changePageTitle, call('onLeave', { prev: true }), call('onEnter'), call('thunk', { cache: true }), call('onComplete')];
  var location = options.location,
      title = options.title,
      formatRoute = options.formatRoute,
      _options$createHistor = options.createHistory,
      createSmartHistory = _options$createHistor === undefined ? createHistory : _options$createHistor,
      _options$createReduce = options.createReducer,
      createLocationReducer = _options$createReduce === undefined ? createReducer : _options$createReduce,
      _options$createInitia = options.createInitialState,
      createState = _options$createInitia === undefined ? createReducer_createInitialState : _options$createInitia,
  ...
  options.onError = typeof onErr !== 'undefined' ? onErr : logError["a" /* onError */];
  ...
  var selectTitleState = createSelector('title', title);
...
/* harmony default export */ var makeActionCreator = (function (route, type, key, basename) {
  ...
  var defaultCreator = function defaultCreator(arg, info) {
    ...
    if (isAction(arg)) return { type: type, basename: basename, ...arg };
...
function createScene_toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }
