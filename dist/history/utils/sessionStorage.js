...
exports.replaceState = exports.pushState = exports.get = exports.set = exports.clear = exports.restoreHistory = exports.saveHistory = undefined;
...
var saveHistory = exports.saveHistory = function saveHistory(_ref, out) {
  ...
  set({ index: index, entries: entries, out: out });
};

var restoreHistory = exports.restoreHistory = function restoreHistory(api) {
...
var set = exports.set = function set(v) {
...
var pushState = exports.pushState = function pushState(url) {
  return window.history.pushState({ id: sessionId() }, null, url);
}; // insure every entry has the sessionId (called by `BrowserHistory`)

var replaceState = exports.replaceState = function replaceState(url) {
